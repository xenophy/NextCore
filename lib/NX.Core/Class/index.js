...
NX.Class.registerPreprocessor('requires', require('./preprocessor/requires'), true);
...
NX.Class.setDefaultPreprocessors(['requires', 'extend', 'statics', 'inheritableStatics', 'mixins', 'config']);
