...
module.exports = {
    ...
    // {{{ test iterate#pattern1

    'test iterate#pattern2': function() {
    ...
    // }}}
    // {{{ test iterate#pattern2

    'test iterate#pattern3': function() {
    ...
    // }}}
    // {{{ test iterate#pattern4

    'test iterate#pattern5': function() {
    ...
    // }}}
    // {{{ test iterate#pattern6

    'test iterate#pattern6': function() {
